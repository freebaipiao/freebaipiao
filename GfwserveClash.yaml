...
proxies:
  - {name: "[直连] 月抛aws 速度快 0.7x 解锁流媒体", server: 18.218.198.254, port: 9999, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 18.218.198.254}, udp: true}
  - {name: "电报群 Telegram group: t.me/gfwservice", server: 8.210.55.79, port: 80, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 8.210.55.79}, udp: true}
  - {name: "🇦🇺 [直连] 澳大利亚 0.7x 解锁流媒体", server: 3.106.142.132, port: 9999, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 3.106.142.132}, udp: true}
  - {name: "🇩🇪 [直连] 德国 Netflix DE 0.5x", server: 18.192.212.68, port: 21888, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 18.192.212.68}, udp: true}
  - {name: "🇭🇰 [直连] 香港6 1M Netflix HK 80端口 1x", server: 8.210.55.79, port: 80, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 8.210.55.79}, udp: true}
  - {name: "🇮🇩 [直连] 雅加达 解锁流媒体 0.7x", server: 108.136.139.33, port: 21888, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 108.136.139.33}, udp: true}
  - {name: "🇱🇺 [直连/反代优选] 卢森堡 跑BT CF优化 0x", server: cf.kycc-nodes.bike, port: 443, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: true, skip-cert-verify: false, network: ws, ws-path: kycc, ws-headers: {Host: lsb.stupidfellow.cf}, udp: true}
  - {name: "🇱🇺 [直连] 卢森堡 跑BT 0x", server: 104.244.79.119, port: 80, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 104.244.79.119}, udp: true}
  - {name: "🇳🇱 [直连] 荷兰", server: 178.62.224.119, port: 8888, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 178.62.224.119}, udp: true}
  - {name: "🇸🇬 [直连] 新加坡1 Netflix SG 0.7x", server: 18.141.180.10, port: 9999, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 18.141.180.10}, udp: true}
  - {name: "🇹🇼 [直连] 台湾2 Netflix TW", server: tw1.yyyywe.top, port: 10561, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: tw1.yyyywe.top}, udp: true}
  - {name: "🇺🇸 [直连] 美国2 0x", server: 155.94.197.20, port: 11021, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 155.94.197.20}, udp: true}
  - {name: "🇺🇸 [直连] 美国8", server: 107.161.50.42, port: 22401, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 107.161.50.42}, udp: true}
  - {name: "🇿🇦 [直连] 南非", server: 169.239.129.33, port: 12501, type: vmess, uuid: d064d11b-477c-4c5d-a2d8-9fd599ef8e79, alterId: 1, cipher: auto, tls: false, skip-cert-verify: false, network: ws, ws-path: /, ws-headers: {Host: 169.239.129.33}, udp: true}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ♻️ 自动选择
      - DIRECT
      - "[直连] 月抛aws 速度快 0.7x 解锁流媒体"
      - "电报群 Telegram group: t.me/gfwservice"
      - 🇦🇺 [直连] 澳大利亚 0.7x 解锁流媒体
      - 🇩🇪 [直连] 德国 Netflix DE 0.5x
      - 🇭🇰 [直连] 香港6 1M Netflix HK 80端口 1x
      - 🇮🇩 [直连] 雅加达 解锁流媒体 0.7x
      - 🇱🇺 [直连/反代优选] 卢森堡 跑BT CF优化 0x
      - 🇱🇺 [直连] 卢森堡 跑BT 0x
      - 🇳🇱 [直连] 荷兰
      - 🇸🇬 [直连] 新加坡1 Netflix SG 0.7x
      - 🇹🇼 [直连] 台湾2 Netflix TW
      - 🇺🇸 [直连] 美国2 0x
      - 🇺🇸 [直连] 美国8
      - 🇿🇦 [直连] 南非
